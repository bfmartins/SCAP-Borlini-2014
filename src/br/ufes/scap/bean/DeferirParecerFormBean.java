...
@SessionScoped
@ManagedBean(name = "DeferirParecerFormBean")
public class DeferirParecerFormBean{
	...
	//codigo da solicitação a ser trazida do banco
	private int codigo;
	...
	public void onbtnPesquisar(ActionEvent actionEvent){
		...
		//vetor de solicitacoes que são exibidas na DataTable
